...
function Main() {
  ...
  return (
    <>
      <h2 className="mt-10 text-lg font-medium intro-y">Conferences</h2>
                ...
                <Table.Tr key={key} className="intro-x">
                  ...
                  <Table.Td className="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
                    ...
                    <div className="text-slate-500 text-xs whitespace-nowrap mt-0.5">
                      {formatDate(conference.startDate, "DD MMM YYYY") + " - " + formatDate(conference.endDate, "DD MMM YYYY")}
                    </div>
                  </Table.Td>
                  <Table.Td className="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
                    <div className="text-slate-500 text-xs whitespace-nowrap mt-0.5">
                  ...
                  <Table.Td className="first:rounded-l-md last:rounded-r-md w-40 bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
                    <div
                      className={clsx([
                        ...
                        { "text-success": conference.status },
                        { "text-danger": !conference.status },
                      ])}
                    >
        ...
        <div className="flex flex-wrap items-center col-span-12 intro-y sm:flex-row sm:flex-nowrap">
          <Pagination className="w-full sm:w-auto sm:mr-auto">
            ...
            {_.times(pagination.total_pages).map((page, key) => (
              page + 1 == pagination.current_page ? <Pagination.Link active key={key}>{page + 1}</Pagination.Link> : <Pagination.Link key={key}>{page + 1}</Pagination.Link>
            ))}
            <Pagination.Link>
