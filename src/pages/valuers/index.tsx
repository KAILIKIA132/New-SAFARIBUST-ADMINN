...
//   const [valuerId, setValuerId] = useState(null);
...
//   const getValuers = async () => {
//     isLoading(true);
//     try {
//       let res = await ApiService.getValuers({ page: 1 });
//       // setUsers(res);
//       setValuers(res.valuers);
//       console.log(res);
//       isLoading(false);
...
//         console.log(data);
//         let res = await ApiService.addValuers(data);
//         getValuers();
//         await reset();
//         isLoading(false);
//         setDialog(false);
...
//     isLoading(true);
//     try {
//       let res = await ApiService.deleteValuer(valuerId);
//       getValuers();
//       isLoading(false);
...
//             <Pagination.Link onClick={() => (setPage(previous_page), getValuers())} >
//               <Lucide icon="ChevronLeft" className="w-4 h-4" />
//             </Pagination.Link>
//             {_.times(pagination.total_pages).map((page, key) => (
//               page + 1 == pagination.current_page ? <Pagination.Link onClick={() => (setPage(page + 1), getValuers())} active key={key}>{page + 1}</Pagination.Link> : <Pagination.Link onClick={() => (setPage(page + 1), getValuers())} key={key}>{page + 1}</Pagination.Link>
//             ))}
//             <Pagination.Link onClick={() => (setPage(next_page), getValuers())} >
...
//                   placeholder="e.g Stanbic valuersk"
//                 />
//                 {errors.name && (
...
function Main() {
  ...
  const schema = yup
    .object({
      name: yup.string().required("Valuer name is required"),
      ...
      >
        <Dialog.Panel>
          <form className="validate-form" onSubmit={onSubmit}>
            ...
            <Dialog.Footer>
              <Button type="button" variant="outline-secondary" onClick={() => (reset({ name: "" }), setDialog(false))}
                className="w-20 mr-1"
              >
                Cancel
              </Button>
